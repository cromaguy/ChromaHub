...
namespace ChromaHub
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
            ...
            IProjectsPage_Bindings
        {
            ...
            {
                if (lineNumber == 142 && columnNumber == 64)
                {
            ...
            IProjectsPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 162 && columnNumber == 46)
                {
                ...
                else if (lineNumber == 184 && columnNumber == 49)
                {
                ...
                else if (lineNumber == 194 && columnNumber == 49)
                {
                    isobj11TagDisabled = true;
                }
                else if (lineNumber == 117 && columnNumber == 44)
                {
            ...
            IProjectsPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 91 && columnNumber == 58)
                {
